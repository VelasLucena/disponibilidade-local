...
const DEFAULT_SEARCH_CRITERIA = {
  ...
  returnDate: 'sex, 15 mai',
  multiSegments: [],
  hotelDestination: 'Rio de Janeiro',
  checkInDate: 'qui, 14 mai',
  checkOutDate: 'sex, 15 mai',
...
const FEATURED_HOTELS = [
  {
    id: 1,
    name: 'Ibis Sao Paulo Paulista',
    city: 'Sao Paulo, SP',
    rating: '3 estrelas',
    price: 'R$ 250',
    imageUrl: 'https://images.unsplash.com/photo-1551882547-ff40c0d5bf8f?auto=format&fit=crop&w=600&q=80'
  },
  {
    id: 2,
    name: 'Novotel RJ Praia de Botafogo',
  ...
  },
  {
    ...
    rating: '5 estrelas',
    price: 'R$ 550',
    imageUrl: 'https://images.unsplash.com/photo-1542314831-c6a4d14d285b?auto=format&fit=crop&w=600&q=80'
  }
];

const HOTEL_PROGRESS = {
  ...
  fontesFalha: 4,
  fontes: [
    { codSisRes: 'B2B', status: 'Concluida', quantidade: 4, erro: null },
    { codSisRes: 'BBT', status: 'Falha', quantidade: 0, erro: '104 Invalid Agency Header Details!' },
    { codSisRes: 'CMN', status: 'Falha', quantidade: 0, erro: 'Ocorreu um erro no fornecedor.' },
    { codSisRes: 'OMN', status: 'Falha', quantidade: 0, erro: 'Authorization error: Invalid username, password and/or id.' },
    { codSisRes: 'TRD', status: 'Falha', quantidade: 0, erro: 'Erro ao converter retorno do fornecedor.' }
  ]
};
...
const HOTEL_OPTIONS = [
  {
    ...
    ofertas: [
      { id: 'o1', codSisRes: 'B2B', preco: 100, violouPolitica: false },
      { id: 'o2', codSisRes: 'TRD', preco: 125, violouPolitica: true, tratamento: 'Alerta', motivoViolacao: 'Acima da menor tarifa' },
      { id: 'o3', codSisRes: 'OMN', preco: 140, violouPolitica: true, tratamento: 'Alerta', motivoViolacao: 'Acima da menor tarifa' }
    ]
  },
  {
    idReferencia: 'a043883304bc4a5380c7abb0e907393c',
    nomeHotel: 'ARGENTINA HOTEL',
    imagem: 'https://dadosb2b.s3.us-west-2.amazonaws.com/dev/imgHotel/U9kQYcHCDE-aliceHTL3.jpg',
    categoria: 3,
    ...
    violouPolitica: true,
    tratamento: 'Alerta',
    motivoViolacao: 'Acima do limite da menor tarifa (R$ 100,00)',
    ofertas: [
      { id: 'o4', codSisRes: 'TRD', preco: 300, violouPolitica: true, tratamento: 'Alerta', motivoViolacao: 'Acima do limite da menor tarifa (R$ 100,00)' }
    ]
  },
  {
    ...
    violouPolitica: true,
    tratamento: 'Bloqueio',
    motivoViolacao: 'Hotel bloqueado pela politica da empresa',
    ofertas: [
      { id: 'o5', codSisRes: 'OMN', preco: 1000, violouPolitica: true, tratamento: 'Bloqueio', motivoViolacao: 'Hotel bloqueado pela politica da empresa' },
      { id: 'o6', codSisRes: 'B2B', preco: 1050, violouPolitica: true, tratamento: 'Bloqueio', motivoViolacao: 'Hotel bloqueado pela politica da empresa' }
    ]
  },
  {
    ...
    motivoViolacao: 'Acima do limite da menor tarifa (R$ 100,00)',
    ofertas: [
      { id: 'o7', codSisRes: 'B2B', preco: 1000, violouPolitica: true, tratamento: 'Alerta', motivoViolacao: 'Acima do limite da menor tarifa (R$ 100,00)' }
    ]
  }
];

const HOTEL_ROOM_TARIFFS = [
  {
    idReferenciaTarifa: '3191a97ae201499fa7f7a8fc1b307bad',
    codigo: '807.52087',
    nome: 'MIO LUXO TWIN-TARIFA',
    tipoQuarto: 'MIO LUXO TWIN',
    descricao: 'Apartamento luxo com duas camas, mesa de trabalho e vista para a Barra.',
    pensao: 'Cafe da Manha.',
    cafeDaManha: true,
    quantidadeDisponivel: 2,
    valores: { moeda: 'BRL', diaria: 1000, taxas: 0, total: 1000 }
  },
  {
    idReferenciaTarifa: '11f2c2ddfad04a24bbaf0a6e639267e2',
    codigo: '807.52088',
    nome: 'MIO LUXO TWIN-TARIFA',
    tipoQuarto: 'MIO LUXO TWIN',
    descricao: 'Mesmo quarto, com regra flexivel para alteracao ate o check-in.',
    pensao: 'Cafe da Manha.',
    cafeDaManha: true,
    quantidadeDisponivel: 1,
    valores: { moeda: 'BRL', diaria: 1100, taxas: 0, total: 1100 }
  },
  {
    idReferenciaTarifa: '2f48fbfc4a3f4dff8f97496d3599a68f',
    codigo: '806.52087',
    nome: 'MIO LUXO KING-TARIFA',
    tipoQuarto: 'MIO LUXO KING',
    descricao: 'Apartamento luxo com cama king, bancada executiva e cafe incluso.',
    pensao: 'Cafe da Manha.',
    cafeDaManha: true,
    quantidadeDisponivel: 2,
    valores: { moeda: 'BRL', diaria: 1000, taxas: 0, total: 1000 }
  ...
  {
    idReferenciaTarifa: '3aafec8eacc04527b306b15aab5e1a37',
    codigo: '806.52088',
    nome: 'MIO LUXO KING-TARIFA',
    tipoQuarto: 'MIO LUXO KING',
    descricao: 'Cama king com politica flexivel e pagamento no checkout.',
    pensao: 'Cafe da Manha.',
    cafeDaManha: true,
    quantidadeDisponivel: 1,
    valores: { moeda: 'BRL', diaria: 1100, taxas: 0, total: 1100 }
...
const HOTEL_TARIFFING_TEMPLATE = {
  tarifacaoId: '0a989eb08b43449e829582be0d32210e',
  sistemaReserva: { codSisRes: 'B2B', idAgencia: 1 },
  valores: {
    quantidadeDiarias: 1,
    rac: 0,
    totalComRac: 1000,
  ...
  cancelamento: {
    limite: '2026-08-29T14:00:00-03:00',
    permiteReservarSemPrazo: true,
    bloqueadoPorPrazoAusente: false
  },
  pagamento: {
    garantiasAceitas: ['Cash', 'Checkout', 'CreditCard'],
    opcoesAceitas: ['DiariaEExtras', 'DiariaEExtrasSemBebidasAlcolicas', 'SomenteDiarias', 'DiariaELavanderia', 'DiariaECafe']
  },
  politicasFornecedor: [
    {
      titulo: 'Politicas do Hotel',
      conteudo: 'Tarifas incluem cafe da manha servido no restaurante do hotel. Horario de check-in a partir das 14 horas e check-out ate as 12 horas. O hotel e 100% nao fumante.'
    },
    {
      titulo: 'Politicas do Hotel',
      conteudo: 'Cancelamento gratuito ate 29/08/2026 14:00. Check-in permitido somente apos as 14:00. Check-out as 12:00.'
    }
  ],
  politicasEmpresa: [
    { tipo: 'MenorTarifa', violou: true, valor: 100, tratamento: 'Alerta' },
    { tipo: 'AntecedenciaMinima', violou: false, valor: 1, tratamento: 'Alerta' }
  ],
  regrasEmpresa: [
...
const SearchScreen = ({ criteria, onCriteriaChange, onSubmit, inline = false, showFeaturedFlights = true, serviceType = 'air', onServiceChange = () => {}, selectedCompany = null, onCompanyChange = () => {} }) => {
  ...
  const handleHotelFilterChange = (field, value) => {
    setHotelFiltersData(prev => ({ ...prev, [field]: value }));
  };
  const clearHotelSearchFilters = () => {
    setHotelFiltersData({
      valorMinimo: '',
      valorMaximo: '',
      nomeHotel: '',
    ...
    <section className="dv-search-hero">
      ...
      <div className="dv-service-tabs" aria-label="Servicos de viagem">
        <div className="dv-service-tab-list">
          ...
          <button type="button" className={`dv-service-tab ${serviceType === 'hotel' ? 'is-active' : ''}`} onClick={() => onServiceChange('hotel')}><span className="q-icon">hotel</span>Hotel</button>
    ...
    <section className="dv-search-shell">
      <form className="dv-booking-card" onSubmit={onSubmit}>
        <div className="dv-booking-top">
          {isHotelService ? (
            <div className="dv-booking-service-title">
              <span className="q-icon">hotel</span>
        ...
        {isHotelService ? (
          <div className="dv-hotel-search-grid">
            <label className="dv-booking-field dv-booking-field--route">
              ...
              <span className="dv-booking-field__body">
                <span className="q-icon">location_on</span>
                <span className="dv-booking-route-copy">
                  <input
                    className="dv-booking-input"
                    value={criteria.hotelDestination || 'Rio de Janeiro'}
                    placeholder="Cidade, bairro, ponto de interesse ou nome do hotel"
                    onChange={(event) => onCriteriaChange('hotelDestination', event.target.value)}
                  />
                </span>
              </span>
            </label>
            ...
            <label className="dv-booking-field dv-booking-field--date">
              <span className="dv-booking-label">Check-in</span>
              <span className="dv-booking-field__body">
                <span className="q-icon">calendar_month</span>
                <input
                  className="dv-booking-input"
                  value={criteria.checkInDate || 'qui, 14 mai'}
                  onChange={(event) => onCriteriaChange('checkInDate', event.target.value)}
                />
              </span>
            </label>

            <label className="dv-booking-field dv-booking-field--date">
              <span className="dv-booking-label">Check-out</span>
              <span className="dv-booking-field__body">
                <span className="q-icon">event_available</span>
                <input
                  className="dv-booking-input"
                  value={criteria.checkOutDate || 'sex, 15 mai'}
                  onChange={(event) => onCriteriaChange('checkOutDate', event.target.value)}
                />
              </span>
            </label>
          ...
          <div className="dv-advanced-filters dv-hotel-search-filter">
            ...
            <section className="dv-hotel-search-filter__section">
              ...
              <input
                ...
                max="2000"
                step="50"
                value={hotelFiltersData.valorMaximo || 2000}
              ...
              <div className="dv-hotel-search-filter__chips">
                {[
                  ...
                  <button
                    key={value}
                    type="button"
                    className={`dv-hotel-search-filter__chip ${hotelFiltersData.valorMaximo === value ? 'is-active' : ''}`}
                    onClick={() => handleHotelFilterChange('valorMaximo', value)}
                  >
                    {label}
                  </button>
                ))}
              ...
              <div className="dv-hotel-search-filter__stars">
                {[1, 2, 3, 4, 5].map(star => (
                  <button
                    key={star}
                    type="button"
                    className={`dv-hotel-search-filter__star ${Number(hotelFiltersData.categoriaMinima) >= star ? 'is-active' : ''}`}
                    onClick={() => handleHotelFilterChange('categoriaMinima', String(star))}
                  >
      ...
      {showFeaturedFlights && !isHotelService && (
      ...
      {showFeaturedFlights && isHotelService && (
        <section className="dv-featured-flights" aria-label="Hoteis corporativos em destaque">
          <div className="dv-featured-flights__header">
            <h2>Hoteis corporativos em destaque</h2>
          </div>

          <div className="dv-featured-grid">
            {FEATURED_HOTELS.map(hotel => (
              <article className="dv-featured-card" key={hotel.id}>
                <div className="dv-featured-card__image">
                ...
                <div className="dv-featured-card__body">
                  ...
                  <div className="dv-featured-price-row">
                    <span>
                      <small>Diaria a partir de</small>
...
const HotelStars = ({ count }) => (
  <span className="dv-hotel-stars" aria-label={`${count} estrelas`}>
    {Array.from({ length: 5 }).map((_, index) => (
      <Star key={index} size={14} fill={index < count ? 'currentColor' : 'none'} color={index < count ? '#f5a623' : '#d1d5db'} />
    ))}
  </span>
);

const HotelAvailabilityScreen = ({ searchCriteria, onSelectHotel }) => {
  ...
  const HotelFilterSection = ({ id, title, icon: Icon, children }) => (
    <section className="dv-hotel-filter-section">
      <button type="button" className="dv-hotel-filter-header" aria-expanded={expandedFilters[id]} onClick={() => toggleHotelFilter(id)}>
        <strong>{Icon && <Icon size={17} />} {title}</strong>
        <span className="q-icon">{expandedFilters[id] ? 'expand_less' : 'expand_more'}</span>
      </button>
      {expandedFilters[id] && <div className="dv-hotel-filter-body">{children}</div>}
    </section>
  );

  const HotelCheck = ({ label, count, icon: Icon }) => (
    <label className="dv-hotel-check">
      <span className="dv-hotel-check-main">
        <input type="checkbox" />
        {Icon && <Icon size={14} />}
        <span>{label}</span>
      </span>
      {typeof count !== 'undefined' && <span className="dv-hotel-check-count">{count}</span>}
    </label>
  );

  return (
    <section className="dv-inline-results dv-inline-results--availability">
      <div className="dv-hotel-results">
        <div className="dv-hotel-layout">
          <aside className="dv-hotel-sidebar">
            <div className="dv-hotel-filter-card">
              <div className="dv-hotel-filter-head">
                <span className="dv-hotel-filter-title"><Filter size={18} /> Filtros</span>
                <button type="button" className="dv-hotel-clear">Limpar tudo</button>
              </div>

              <HotelFilterSection id="stars" title="Categoria" icon={Star}>
                <HotelCheck label={<HotelStars count={5} />} count={1} />
                <HotelCheck label={<HotelStars count={4} />} count={2} />
                <HotelCheck label={<HotelStars count={3} />} count={1} />
              </HotelFilterSection>

              <HotelFilterSection id="price" title="Faixa de preco" icon={DollarSign}>
                <div className="dv-hotel-price-row"><span>R$ 50</span><strong>R$ 1.500</strong></div>
                <input type="range" min="50" max="2000" value="1500" readOnly className="dv-range-input" />
              </HotelFilterSection>

              <HotelFilterSection id="amenities" title="Comodidades" icon={Coffee}>
                <HotelCheck label="Cafe da manha" count={3} icon={Coffee} />
                <HotelCheck label="Cama de casal" count={4} icon={BedDouble} />
                <HotelCheck label="Wi-Fi gratis" count={4} />
                <HotelCheck label="Piscina" count={2} />
              </HotelFilterSection>

              <HotelFilterSection id="location" title="Bairro / Regiao" icon={MapPin}>
                <HotelCheck label="Barra da Tijuca" count={3} />
                <HotelCheck label="Flamengo" count={1} />
                <HotelCheck label="Copacabana" />
                <HotelCheck label="Ipanema" />
              </HotelFilterSection>
            </div>
          </aside>

          <main className="dv-hotel-content">
            <section className="dv-hotel-progress">
              <div className="dv-hotel-progress-summary">
                <div className="dv-hotel-progress-main">
                  <span className="dv-hotel-progress-icon"><span className="q-icon">check</span></span>
                  <span className="dv-hotel-progress-copy">
                    <strong>Busca concluida</strong>
                    <span>{HOTEL_PROGRESS.fontesConcluidas} de {HOTEL_PROGRESS.totalFontes} fontes pesquisadas ({HOTEL_PROGRESS.fontesSucesso} com sucesso)</span>
                  </span>
                </div>
                <div className="dv-hotel-progress-bar"><div className="dv-hotel-progress-fill" style={{ width: `${HOTEL_PROGRESS.progressoPercentual}%` }} /></div>
              </div>

              <div className="dv-hotel-provider-grid">
                {HOTEL_PROGRESS.fontes.map(fonte => {
                  const isSuccess = fonte.status === 'Concluida';
                  return (
                    <div className="dv-hotel-provider" key={fonte.codSisRes} title={fonte.erro || ''}>
                      <span className="dv-hotel-provider-name">VIA {fonte.codSisRes}</span>
                      <span className={`dv-hotel-provider-status dv-hotel-provider-status--${isSuccess ? 'success' : 'failed'}`}>
                        <span className="q-icon">{isSuccess ? 'check_circle' : 'info'}</span>
                        {isSuccess ? `${fonte.quantidade} hoteis` : 'Falha'}
                      </span>
                    </div>
                  );
                })}
            ...
            <div className="dv-hotel-results-head">
              <div>
                <h2>Hoteis em {searchCriteria.hotelDestination || 'Rio de Janeiro'}</h2>
                <p>Encontramos {HOTEL_OPTIONS.length} opcoes disponiveis para voce</p>
              </div>
              <select className="dv-sort-select" defaultValue="price">
                <option value="price">Menor preco</option>
                <option value="recommended">Mais recomendados</option>
                <option value="stars">Maior categoria</option>
              </select>
            </div>

            <div className="dv-hotel-list">
              {HOTEL_OPTIONS.map(hotel => {
                const isBlocked = hotel.violouPolitica && hotel.tratamento === 'Bloqueio';
                  ...
                  <article key={hotel.idReferencia} className={`dv-hotel-card ${isBlocked ? 'is-blocked' : ''} ${hasSelectedOffer ? 'is-selected' : ''} ${isExpanded ? 'is-dropdown-open' : ''}`}>
                    <div className="dv-hotel-card-main">
                      <div className="dv-hotel-image">
                        ...
                        {hotel.marcadores.includes('MenorDiaria') && <span className="dv-hotel-badge">Menor tarifa</span>}
                      </div>

                      <div className="dv-hotel-info">
                        <div>
                          <div className="dv-hotel-title-row">
                            <h3>{hotel.nomeHotel}</h3>
                            <HotelStars count={hotel.categoria} />
                          </div>
                          <div className="dv-hotel-address"><MapPin size={14} /> <span>{hotel.endereco}</span></div>
                          <div className="dv-hotel-tags">
                            {hotel.marcadores.includes('OfereceCafeDaManha') && <span className="dv-hotel-tag dv-hotel-tag--green"><Coffee size={13} /> Cafe da manha</span>}
                            <span className="dv-hotel-tag"><BedDouble size={13} /> Quarto padrao</span>
                          </div>
                          {hotel.violouPolitica && (
                            <span className={`dv-hotel-policy dv-hotel-policy--${hotel.tratamento === 'Bloqueio' ? 'danger' : 'warning'}`}>
                              {hotel.tratamento === 'Bloqueio' ? <ShieldAlert size={14} /> : <Info size={14} />}
                              {hotel.motivoViolacao}
                            </span>
                          )}
                        </div>
                      </div>

                      <div className="dv-hotel-action">
                        <div>
...
const HotelStepHeader = ({ hotel, searchCriteria, offer, title, onBack, hero = false }) => (
  <header className={`dv-hotel-step-header ${hero ? 'dv-hotel-step-header--hero' : ''}`}>
    {hero && (
      <div className="dv-hotel-step-hero-image">
        <img src={hotel.imagem} alt={hotel.nomeHotel} />
      </div>
    )}
    <div className="dv-hotel-step-title">
      {!hero && (
        <span className="dv-hotel-step-thumb">
          <img src={hotel.imagem} alt={hotel.nomeHotel} />
        </span>
      )}
      <div>
        <h2>{title}</h2>
        <p>{hotel.nomeHotel} - {hotel.endereco}</p>
        <div className="dv-hotel-step-meta">
          <span className="dv-hotel-step-chip"><span className="q-icon">calendar_month</span>{searchCriteria.checkInDate} ate {searchCriteria.checkOutDate}</span>
          <span className="dv-hotel-step-chip"><span className="q-icon">hotel</span>{formatGuestLabel(Math.max(1, searchCriteria.passengers?.length || 1))}</span>
          <span className="dv-hotel-step-chip"><Network size={13} />Via {offer?.codSisRes || 'B2B'}</span>
        </div>
      </div>
    </div>
...
const HotelRoomsScreen = ({ hotel, offer, searchCriteria, onBack, onSelectTariff }) => {
  const cheapestTotal = Math.min(...HOTEL_ROOM_TARIFFS.map(tariff => tariff.valores.total));
  const nights = 1;
    ...
    <section className="dv-inline-results dv-inline-results--availability">
      <div className="dv-hotel-step">
        <HotelStepHeader
          ...
          title="Escolha o quarto"
          onBack={onBack}
          hero
        />

        <div className="dv-hotel-room-layout">
          <main className="dv-hotel-room-list">
            <div className="dv-hotel-room-head">
              <h3>Quartos disponiveis <span>({HOTEL_ROOM_TARIFFS.length})</span></h3>
            </div>
            {HOTEL_ROOM_TARIFFS.map(tariff => {
              const isBest = tariff.valores.total === cheapestTotal;
              const violatesPolicy = tariff.valores.total > 1050;

              return (
                <article className="dv-hotel-room-card" key={tariff.idReferenciaTarifa}>
                  <div className="dv-hotel-room-main">
                    <div className="dv-hotel-room-name">
                      <div>
                        <h3>{tariff.tipoQuarto}</h3>
                        <span className="dv-hotel-room-code">Codigo {tariff.codigo}</span>
                      </div>
                      {isBest && <span className="dv-hotel-best"><Sparkles size={10} /> Melhor tarifa</span>}
                    </div>
                    <p className="dv-hotel-room-description">{tariff.descricao}</p>
                    <div className="dv-hotel-room-tags">
                      <span className="dv-hotel-room-tag is-included"><Coffee size={13} /> {tariff.pensao}</span>
                      <span className="dv-hotel-room-tag"><BedDouble size={13} /> {tariff.nome}</span>
                      <span className="dv-hotel-room-tag"><span className="q-icon">meeting_room</span>{tariff.quantidadeDisponivel || 1} disponivel</span>
                      {violatesPolicy && <span className="dv-hotel-policy dv-hotel-policy--warning"><Info size={13} /> Acima da politica</span>}
                    </div>
                  </div>

                  <div className="dv-hotel-room-action">
                    <div className="dv-hotel-room-price">
                      {formatCurrency(tariff.valores.total)}
                      <span>total por {nights} noite</span>
                    </div>
                    <button type="button" className="dv-hotel-room-button" onClick={() => onSelectTariff(tariff)}>
                      Tarifar quarto
                    </button>
                  </div>
                </article>
          ...
          <aside className="dv-hotel-room-side">
            <div className="dv-hotel-side-card">
              <h3>Consulta de tarifas</h3>
              <div className="dv-hotel-side-row"><span>ID consulta</span><strong>d7632ee2...</strong></div>
              <div className="dv-hotel-side-row"><span>Quartos</span><strong>{HOTEL_ROOM_TARIFFS.length}</strong></div>
              <div className="dv-hotel-side-row"><span>Fornecedor</span><strong>{offer?.codSisRes || 'B2B'}</strong></div>
              <div className="dv-hotel-side-row"><span>Menor total</span><strong>{formatCurrency(cheapestTotal)}</strong></div>
            </div>
          </aside>
        </div>
      </div>
...
const HotelTariffingScreen = ({ hotel, offer, tariff, searchCriteria, onBack }) => {
  const initialGuests = useMemo(() => {
    const selected = getSelectedPassengers(searchCriteria.passengers, searchCriteria.customPassengers);
    return selected.length > 0
      ? selected.map(guest => guest.name)
      : ['Matheus Castro (Voce)'];
  ...
  const tariffing = {
    ...
    localizacao: {
      ...
      cidade: 'Rio de Janeiro, Galeao/Antonio Carlos Jobim',
      latitude: -22.9729812,
      longitude: -43.3907755
    },
    tarifa: tariff,
    valores: {
      ...HOTEL_TARIFFING_TEMPLATE.valores,
      diaria: tariff.valores.diaria,
      taxas: tariff.valores.taxas,
      total: tariff.valores.total,
  ...
  const availableGuests = ['Matheus Castro (Voce)', 'Ana Costa', 'Julio Cesar', 'Fernanda Lima', 'Roberto Alves', 'Carla Dias'];
  const filteredGuests = availableGuests.filter(guest => (
    guest.toLowerCase().includes(guestInput.trim().toLowerCase()) &&
  ...
  const addGuest = (guest) => {
    if (!guest || selectedGuests.includes(guest)) return;
  ...
  const removeGuest = (guest) => {
    setSelectedGuests(prev => (
      prev.length <= 1 ? prev : prev.filter(item => item !== guest)
    ));
  };

  const BillingField = ({ label, field, options, wide = false }) => (
    <label className={`dv-hotel-billing-field ${wide ? 'dv-hotel-billing-field--wide' : ''}`}>
      <span>{label}</span>
      {options ? (
        <select
          className="dv-hotel-billing-input"
          value={billingData[field]}
          onChange={(event) => updateBillingData(field, event.target.value)}
        >
        ...
        <div className="dv-hotel-tariff-layout dv-hotel-tariff-layout--checkout">
          <main className="dv-hotel-tariff-main dv-hotel-checkout-main">
              ...
              <div className="dv-hotel-review-card__body">
                ...
                <div className="dv-hotel-stay-grid">
                  <div className="dv-hotel-stay-box">
                    <span>Check-in</span>
                    <strong>{searchCriteria.checkInDate}</strong>
                    <small>A partir das 14:00</small>
                  </div>
                  <div className="dv-hotel-stay-box">
                    <span>Check-out</span>
                    <strong>{searchCriteria.checkOutDate}</strong>
                    <small>Ate as 12:00</small>
                  </div>
                </div>

                <div className="dv-hotel-selected-room">
                  <div>
                    <span className="dv-hotel-selected-badge">Quarto selecionado</span>
                    <h4>{tariff.tipoQuarto}</h4>
                    <p>{tariff.codigo} - {tariff.nome}</p>
                  </div>
                  <div className="dv-hotel-selected-amenities">
                    <span className="dv-hotel-selected-amenity"><Coffee size={13} /> {tariff.pensao}</span>
                    <span className="dv-hotel-selected-amenity"><BedDouble size={13} /> {tariff.quantidadeDisponivel || 1} disponivel</span>
                    <span className="dv-hotel-status dv-hotel-status--ok"><CheckCircle size={13} /> Tarifado</span>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="dv-hotel-review-card dv-hotel-checkout-card">
              ...
              <div className="dv-hotel-review-card__body">
                {violatesLowestFare && (
                  <div className="dv-hotel-policy-alert">
                    <ShieldAlert size={19} />
                    <div>
                      <strong>Excecao a politica corporativa</strong>
                      <p>Valor da diaria excede o teto de R$ 1.050,00. Esta reserva deve seguir fluxo de aprovacao.</p>
                    </div>
                  </div>
                )}

                <div className="dv-hotel-policy-list">
                  {tariffing.politicasEmpresa.map(policy => (
                    <div className="dv-hotel-tariff-row" key={policy.tipo}>
                      <span>{policy.tipo}</span>
                      <strong className={`dv-hotel-status ${policy.violou || (policy.tipo === 'MenorTarifa' && violatesLowestFare) ? 'dv-hotel-status--warning' : 'dv-hotel-status--ok'}`}>
                        {policy.violou || (policy.tipo === 'MenorTarifa' && violatesLowestFare) ? 'Violada' : 'Cumprida'}
                      </strong>
                    </div>
                  ))}
                </div>

                <div className="dv-hotel-policy-note">
                  {tariffing.politicasFornecedor.map((policy, index) => (
                    <p className="dv-hotel-policy-text" key={`${policy.titulo}-${index}`}>
                      <strong>{policy.titulo}:</strong> {policy.conteudo}
                    </p>
                  ))}
                </div>
              </div>
            ...
            <section className="dv-hotel-review-card dv-hotel-checkout-card">
              ...
              <div className="dv-hotel-review-card__body">
                ...
                <div className="dv-hotel-guests-section">
                  ...
                  <div className="dv-hotel-guest-picker">
                    <input
                      ...
                      onKeyDown={(event) => {
                        if (event.key !== 'Enter') return;
                        event.preventDefault();
                        addGuest(filteredGuests[0] || guestInput.trim());
                      }}
                      placeholder="Buscar e adicionar hospede..."
                    />
                    {isGuestPickerOpen && filteredGuests.length > 0 && (
                      <div className="dv-hotel-guest-options">
                        {filteredGuests.map(guest => (
                          <button type="button" className="dv-hotel-guest-option" key={guest} onMouseDown={() => addGuest(guest)}>
                            <span className="q-icon">person</span> {guest}
                          </button>
                        ))}
                      </div>
                    )}
                  ...
                  <div className="dv-hotel-guest-list" style={{ marginTop: 12 }}>
...
export default function App() {
  ...
  const [selectedHotelContext, setSelectedHotelContext] = useState(null);
  const [selectedHotelTariff, setSelectedHotelTariff] = useState(null);
  ...
  const scrollToInlineResults = () => {
    window.setTimeout(() => {
      const target = document.querySelector('.dv-inline-results');
      if (!target) return;
  ...
  const openHotelRooms = (hotel, offer = null) => {
    setSelectedHotelContext({ hotel, offer });
    setSelectedHotelTariff(null);
    setCurrentScreen('hotelRooms');
    scrollToInlineResults();
  };

  const openHotelTariffing = (tariff) => {
    setSelectedHotelTariff(tariff);
    setCurrentScreen('hotelTariffing');
    scrollToInlineResults();
  };
  ...
  return (
    <div className="dv-app-container">
      ...
      {currentScreen === 'hotelAvailability' ? (
        <HotelAvailabilityScreen searchCriteria={searchCriteria} onSelectHotel={openHotelRooms} />
      ) : currentScreen === 'hotelRooms' && selectedHotelContext ? (
        <HotelRoomsScreen
          hotel={selectedHotelContext.hotel}
          offer={selectedHotelContext.offer}
          searchCriteria={searchCriteria}
          onBack={() => setCurrentScreen('hotelAvailability')}
          onSelectTariff={openHotelTariffing}
        />
      ) : currentScreen === 'hotelTariffing' && selectedHotelContext && selectedHotelTariff ? (
        <HotelTariffingScreen
          hotel={selectedHotelContext.hotel}
          offer={selectedHotelContext.offer}
          tariff={selectedHotelTariff}
          searchCriteria={searchCriteria}
          onBack={() => setCurrentScreen('hotelRooms')}
        />
